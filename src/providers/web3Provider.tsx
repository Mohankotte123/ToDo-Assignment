...
export const Web3ModalProvider: React.FC<Web3ModalProviderProps> = ({
  ...
  const myTheme = merge(lightTheme(), {
    colors: {
      accentColor: import.meta.env.VITE_APP_BTN_PRIMARY || "#9333ea",
      connectButtonBackground: import.meta.env.VITE_APP_BTN_PRIMARY || "#9333ea",
      connectButtonText: import.meta.env.VITE_APP_BTN_TEXT || "#ffffff",
    },
    radii: {
      connectButton:
    ...
    fonts: {
      body: import.meta.env.VITE_APP_FONT_FAMILY || "'Poppins', sans-serif",
    },
  } as Theme);
